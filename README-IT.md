...
![Ubuntu Server 1](doc/1_Ubuntu_Server/Ubuntu_Server_1.jpg)
...
![Ubuntu Server 2](doc/1_Ubuntu_Server/Ubuntu_Server_2.jpg)
...
![Ubuntu Server 3](doc/1_Ubuntu_Server/Ubuntu_Server_3.jpg)
...
![Ubuntu Server 4](doc/1_Ubuntu_Server/Ubuntu_Server_4.jpg)

![Ubuntu Server 5](doc/1_Ubuntu_Server/Ubuntu_Server_5.jpg)
...
![Ubuntu Server 6](doc/1_Ubuntu_Server/Ubuntu_Server_6.jpg)
...
![Ubuntu Server 7](doc/1_Ubuntu_Server/Ubuntu_Server_7.jpg)
...
![Ubuntu Server 8](doc/1_Ubuntu_Server/Ubuntu_Server_8.jpg)
...
![Ubuntu Server 9](doc/1_Ubuntu_Server/Ubuntu_Server_9.jpg)
...
![Ubuntu Server 10](doc/1_Ubuntu_Server/Ubuntu_Server_10.jpg)
...
![Ubuntu Server 11](doc/1_Ubuntu_Server/Ubuntu_Server_11.jpg)

![Ubuntu Server 12](doc/1_Ubuntu_Server/Ubuntu_Server_12.jpg)
...
![Ubuntu Server 13](doc/1_Ubuntu_Server/Ubuntu_Server_13.jpg)
...
![Ubuntu Server 14](doc/1_Ubuntu_Server/Ubuntu_Server_14.jpg)
...
![Ubuntu Server 15](doc/1_Ubuntu_Server/Ubuntu_Server_15.jpg)

## Installazione del sistema operativo

Ora il sistema operativo viene installato nel disco interno del computer.

![Ubuntu Server 16](doc/1_Ubuntu_Server/Ubuntu_Server_16.jpg)

Alla fine della procedura compare la voce `Reboot Now`. Premere `Invio`.

![Ubuntu Server 17](doc/1_Ubuntu_Server/Ubuntu_Server_17.jpg)
...
![Ubuntu Server 18](doc/1_Ubuntu_Server/Ubuntu_Server_18.jpg)

Ora il computer procederà al riavvio.

![Ubuntu Server 19](doc/1_Ubuntu_Server/Ubuntu_Server_19.jpg)
...
![Pi-Hole 10](doc/3_Pi-Hole/Pi-Hole_10.jpg)
...
![Pi-Hole 11](doc/3_Pi-Hole/Pi-Hole_11.jpg)
...
![Pi-Hole 14](doc/3_Pi-Hole/Pi-Hole_14.jpg)
...
![Pi-Hole 17](doc/3_Pi-Hole/Pi-Hole_17.jpg)
...
![Pi-Hole 18](doc/3_Pi-Hole/Pi-Hole_18.jpg)
...
![Pi-Hole 21](doc/3_Pi-Hole/Pi-Hole_21.jpg)

Se la procedura ha avuto successo comparirà la scritta `New password set`

![Pi-Hole 22](doc/3_Pi-Hole/Pi-Hole_22.jpg)
...
![Unbound 1](doc/4_Unbound/Unbound_1.jpg)

Confermare l'installazione dell'applicazione scrivendo `y` e premendo `Invio`.

![Unbound 2](doc/4_Unbound/Unbound_2.jpg)
...
![Unbound 3](doc/4_Unbound/Unbound_3.jpg)
...
![Unbound 4](doc/4_Unbound/Unbound_4.jpg)

Premere `Invio` per lanciare il tutto.

![Unbound 5](doc/4_Unbound/Unbound_5.jpg)
...
![Unbound 6](doc/4_Unbound/Unbound_6.jpg)
...
![Unbound 10](doc/4_Unbound/Unbound_10.jpg)

Controllare che sia uguale a quanto precedentemente copiato.

![Unbound 11](doc/4_Unbound/Unbound_11.jpg)
...
![Unbound 12](doc/4_Unbound/Unbound_12.jpg)
...
![Unbound 14](doc/4_Unbound/Unbound_14.jpg)
...
![Unbound 16](doc/4_Unbound/Unbound_16.jpg)
...
![Unbound 18](doc/4_Unbound/Unbound_18.jpg)
...
![Pi-Hole Web Interface 1](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_1.jpg)

Dovrebbe comparire una schermata simile. Dal menù a destra cliccare la voce `Login`.

![Pi-Hole Web Interface 2](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_2.jpg)

Verrà chiesta la password di Pi-Hole per l'interfaccia web. Inserirla e cliccare `Login` per confermare ed entrare.

![Pi-Hole Web Interface 3](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_3.jpg)

La seguente schermata è quella prima di fare il login. La differenza è che ora c’è la possibilità di configurare Pi-Hole.

![Pi-Hole Web Interface 4](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_4.jpg)

Cliccare nel menù a sinistra alla voce `Settings`. 

![Pi-Hole Web Interface 5](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_5.jpg)

Cliccare `DNS` dalle voci presenti in alto.

![Pi-Hole Web Interface 6](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_6.jpg)
...
![Pi-Hole Web Interface 7](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_7.jpg)

Nel blocco intitolato `Interface settings`, cliccare la voce `Bind only to interface ...`.

![Pi-Hole Web Interface 8](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_8.jpg)

Per salvare tutto ciò scrollare in giù con il mouse e cliccare `Save` presente in basso a destra nella schermata.

![Pi-Hole Web Interface 9](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_9.jpg)
...
![Pi-Hole Web Interface 10](doc/5_Pi-Hole_Web_Interface/Pi-Hole_Web_Interface_10.jpg)
